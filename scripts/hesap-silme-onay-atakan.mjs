// Pusula Istanbul — Hesap Silme Onay Maili (KVKK Madde 11)
//
// 27 May 2026'da hesabı silinen Atakan Ceyhan'a (atakanceyhan@gmail.com)
// tek seferlik bilgilendirme + KVKK kapanış maili.
//
// Script gelecekteki silme talepleri icin de yeniden kullanilabilir; en
// usteki HEDEF blogunu duzenleyerek baska bir kullaniciya yollayabilirsin.
//
// Kullanim:
//   node scripts/hesap-silme-onay-atakan.mjs --dry             # icerik onizle
//   node scripts/hesap-silme-onay-atakan.mjs --test <email>    # test maili
//   node scripts/hesap-silme-onay-atakan.mjs --send            # HEDEF'e gercek gonderim
//
...
// ===== HEDEF BLOGU — gelecekteki silme talepleri icin sadece bu kismi duzenle =====
const HEDEF = {
  ad: 'Atakan',
  soyad: 'Ceyhan',
  email: 'atakanceyhan@gmail.com',
  silme_tarihi_metin: '27 Mayıs 2026', // mail icindeki tarih ibaresi
};
// ===================================================================================
...
if (mode === '--test') {
  ...
  if (!testEmail) {
    ...
    console.error('  node scripts/hesap-silme-onay-atakan.mjs --test ayse.tokkus@gmail.com');
    process.exit(1);
  }
...
console.error('  node scripts/hesap-silme-onay-atakan.mjs --dry');
console.error('  node scripts/hesap-silme-onay-atakan.mjs --test <email>');
console.error('  node scripts/hesap-silme-onay-atakan.mjs --send');
process.exit(1);
