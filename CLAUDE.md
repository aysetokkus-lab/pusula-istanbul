...
- "Su an hangi surum yayinda?" — **STATE.md'ye bak, sorma. v1.1.1 ANDROID YAYINDA (2 Haz 2026 öğleden sonra), iOS Apple Review'da. v1.1.0 Android sabah yayına çıktı ama 2 kritik bug fark edildi (Android push ses + Genel Duyuru silme UI), hemen v1.1.1 hotfix paketlendi. v1.1.0 iOS review iptal edilip doğrudan v1.1.1'e geçildi. Android `app_versions` UPDATE yapıldı; iOS onay gelince aynısı yapılacak: `UPDATE app_versions SET version='1.1.1' WHERE platform='ios'`.**
